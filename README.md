...
Event Management
— Create and manage events; events can exist without a venueassigned
Booking Management
— Create bookings linking venues and events with unique bookingIDs
Double Booking Prevention
— System automatically blocks conflicting bookings for thesame venue on the same date
